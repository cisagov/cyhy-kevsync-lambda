...
issue](https://github.com/cisagov/cyhy-kevsync-lambda/issues) in this
...
request](https://github.com/cisagov/cyhy-kevsync-lambda/pulls), you will
...
```console
cd cyhy-kevsync-lambda
pyenv virtualenv <python_version_to_use> cyhy-kevsync-lambda
pyenv local cyhy-kevsync-lambda
